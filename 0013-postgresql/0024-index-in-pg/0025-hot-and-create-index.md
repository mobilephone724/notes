...
![image-20240913221635357](0025-001-hot_page.png)
...
![image-20240912110738151](0025-002-hot-insert_1.png)

（二）：当更新 tuple_1 为 (x=1,y=2) 时， 新增 lp_2, 和 tuple_2 ，但是不会新增索引指针，而是由 tuple_1 的 header 会记录 tuple_2 的位置。

![image-20240912110738151](0025-003-hot-insert_2.png)
...
![image-20240912110738151](0025-004-hot-insert_3.png)
...
![image-20240912151435754](0025-005-hot-prune.png)

（五）：defragmentation （碎片整理）：将对应的 tuple 彻底删除，如图

![006-hot-defragmentation](0025-006-hot-defragmentation.png)
...
![007-index-non-hot-dead](0025-007-index-non-hot-dead.png)
...
![008-indcheckxmin](0025-008-indcheckxmin.png)
...
![009-index-entry-use-root](0025-009-index-entry-use-root.png)



如果想去“优化“ 新HOT链的长度，让索引指向 lp_2 或者 lp_3，会产生很多问题，例如指向 lp_3，如果后续更新 tuple3 为 tuple4(x=1,y=2,z=3)，旧很难清理 HOT 链，

![010-index-entry-not-root_1](0025-010-index-entry-not-root_1.png)

在清理时还需要注意 ptr_3 有索引指向，造成代码复杂度很高

![011-index-entry-not-root_2](0025-011-index-entry-not-root_2.png)
...
![012-see-empty-index](0025-012-see-empty-index.png)
...
![013-wait-for-lockers](0025-013-wait-for-lockers.png)
...
![014-cic-phase2-example](0025-014-cic-phase2-example.png)
...
![015-cic-phase3-build](0025-015-cic-phase3-build.png)
...
![016-cic-phase3-wait](0025-016-cic-phase3-wait.png)
...
![017-cic-unique-check_1](0025-017-cic-unique-check_1.png)
...
![018-cic-unique-check_2](0025-018-cic-unique-check_2.png)
